...
void fortunes()
    {
       const char *fort[]={"YOUR TALENTS WIL BE RECOGNIZED AND SUITABLY REWARDED.",
...
void compat(int a)
    {
        const char* love[]={"Both enter with the intent of dominating the scenario. A passionate affair, but neither is content with playing the smaller role. In the genderual relationships between them the woman will dominate. The Aries-man will not stand for a long time the role of subordinated. Each of them will try to become the leader, and it will create the atmosphere of quarrel. As a result it means many problems in a bedroom. While this is definitely not the best union ever found, it can be made to work if both love each other enough to sacrifice a little of self and ego for the sake of the others feelings. Having a Birth Natal Charts made is almost a must for these two as the charts will show where the weakness and the strengths lie and enable them to work around and with these so that they will have a lasting and happy union.",
                      ...
                      "This union can turn out to be delightful, because both Aries and Gemini are tireless, active, inclined to search for a new knowledge. The Aries' tendency to dominate is limited by an ingenuity of the Twins. The Twins have no genderual prejudices, but their energy can search for other ways of satisfaction. Gemini may seek extra stimulation, but is discreet about it. Both minds mesh well; Aries is dynamic and intelligent, Gemini is versatile and ingenious. Aries is likely to be the leader genderually, and Gemini delights in thinking up variations to keep Aires's interest at a peak. The marriage can turn out to be quite successful.",
                      "This combination is usually hard to match. The powerful genderual attraction is a usual thing for these two signs. A problem is that genderual attraction fades in the face of many temperamental differences. Aries leaps without looking; Cancer is cautious. Cancer loves hearth and home; Aries hates being tied down. Resentments build up and they argue over trifles. The discrepancy between their temperaments results in strengthening of incompatibility in bed. Astrological forecast for this couple is a stormy sea, and the marriage for certain will result in ship-wreck.",
                      "Both Aries and Leo have aggressive temperaments. Both have got egos to burn and both like to lead. Aggressive Aries wouldn't dream of taking second place, and kingly Leo needs constant admiration. This is particularly true if Aries will allow Leo to hold the center of the floor on occasions. Sharing the limelight is important on Leo's part however, as Aries will feel the need to be on stage once in a while as well. Aries should flatter the Leo on his/her physical fit. Being so much alike genderually can be one of the important things that will keep them true to their commitments. Between the two of them, if one is loving and tactful with the other, meeting that persons emotional needs they can create a steady and long term union.",
                      "The bravery of the Aries will probably intrigue the imagination of shy, reserved Virgo for a time. However, their genderualities are so different, that they will have to be very patient in order to succeed. Aires's passions are impulsive and direct. Virgo's genderuality is more enigmatic and takes time to be revealed. In other areas Aries is full of exciting new plans and ideas, and insists on being boss. Virgo is critical and fussy, and likes things to be done the way Virgo wants. In case the charts are well aspected for these two it could work, but it will take a lot of effort on both sides. Otherwise the relationships will not be very pleasant and chances for a successful marriage are fifty / fifty.",
                      "There is a powerful initial attraction between these two opposites, for in certain areas each supplies what the other lacks. Both are fond of of genderual pleasures, but the Aries probably will try to go too far too quickly. The Libra is inclined to idealize everything and can lose all illusions. Later Libra will look for someone less demanding, and Aries will bind someone more adoring. The physical connection is possible, but only temporarily. The marriage is very rare.",
                      "The gender can turn out to be either stimulating or useless. There are two directions for the events to develop. Both the Aries, and the Scorpio possess a large amount of physical energy. They are both inclined to act. On the other hand, they are both independent and do not like being controlled. Long-term disagreements may destroy their phenomenal ability to share passion of and with each other. Usually this is an unstable partnership with a low ignition point.",
                      ...
                      "They are perfectly compatible with each other. They are both inventive in love. However, there are no deep feelings between them . They are both too rational, reasonable and moderate for deep and strong feelings. There are many personal interests. Given, that they are unsuited physically, they will not find this odd or a reason to allow hostilities into their relationship, for gender does not play a big role in either ones life as they are easily distracted by daily happenings and other peoples problems. In general it promises to be a peasant connection and reliable marriage as a result.",
                      "In case Pisces study the Aquarian horoscope , this may not be a bad combination. But usually their genderual affinity turns into a war with elements of a melodrama. The sensitive Pisces dependent on the Aquarius too much and constantly demanding the proofs of his/her love. The Aquarius feels depressed. The Pisces is a highly complex personality that must be the center of attention in his/her lovers life, and this is disheartening to Aquarius who believes in developing individuality. Pisces can have deep bouts of depression and if he/she perceives that Aquarius is unsympathetic to these he/she may cut Aquarius off completely and make his/her own private decision about their life together. This connection seems to be promising at first , but it will never get into a happy marriage.",
                      "With these two signs having the same virtues and vices they should get along well together, or at least they will have understanding and sympathy for one another. Their mutual sympathy guarantees that there will be a perfect understanding in the field of genderual needs between them. If their problems can be dissolved on a background of a genderual compatibility, it will be one of the best pairs in the Zodiac. The only possible drawback is a drifting too far from practical realities. To solve this problem they both can be anchored to each other, so that they can put their shoulders to the wheel and face the responsibilities that reality demands. This is seems to be a rather genderual connection. The marriage will be interesting."
                        };
...
void details(char *a,char s,int y)
    {//writing basic in the screen
        gotoxy(55,3);printf("Name= %s", a);
        gotoxy(55,4);printf("Age=%d",(2023-y));
        gotoxy(55,5);printf("Gender(M/F)=%c",toupper(s));
    }
...
int lovemenu()
    {//writing for the love compatibility
         int b;
            gotoxy(5,9);printf("Enter your Partner's horoscope:");
            gotoxy(5,10);printf("-------------------------------------------------------------------");
            gotoxy(5,20);printf("-------------------------------------------------------------------");
        ...
        switch(b)
            {
                case 1:
                    ...
                    gotoxy(30,5);printf("GENDER\tAGE\tDATE OF BIRTH");
                    ...
                    while(fread(&c,sizeof(c),1,fp)==1)
                    {
                        gotoxy(3,i+5);
                        printf("%d  %s",i,c.name);
                        gotoxy(30,i+5);printf("%c  \t%d  \t%d/%d/%d\n",c.gender,(2017-c.yr),c.dy,c.mn,c.yr);
                        delay(1);
                        i++;
                    }
                    printf("\n\n\n\n\nEnter any key to continue....");
                ...
                case 2:
                    ...
                    gotoxy(30,8);printf("GENDER\tAGE\tDATE OF BIRTH");
                    rewind (fp);
                    while(fread(&c,sizeof(c),1,fp)==1)
                        if(strcmp(name,c.name)==0)
                        {
                            ...
                            gotoxy(30,i);printf("%c  \t%d  \t%d/%d/%d\n",toupper(c.gender),(2017-c.yr),c.dy,c.mn,c.yr);
                            delay(1);
                            i++;
                        }
